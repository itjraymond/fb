if ( ! Detector.webgl ) Detector.addGetWebGLMessage();
        ...
        function init() {
            ...
            camera = new THREE.PerspectiveCamera( 3, window.innerWidth / window.innerHeight, 5, 766 );
			...
			var dlight = new THREE.DirectionalLight(0x84b9ff, .6);
			scene.add(dlight);

			var directionalLight = new THREE.DirectionalLight( 0x9e9e9e, .6 );
			...
			var bgMat = new THREE.MeshBasicMaterial( { color: 0x000000, shading: THREE.FlatShading, transparent:true, opacity:.7, vertexColors: THREE.VertexColors } );
