...
function init() {
	...
	loader.load( "models/animated/4.json", function ( geometry ) {
	...
	var loader = new THREE.JSONLoader();
	loader.load( "models/animated/3.json", function ( geometry ) {
		...
		var material = new THREE.MeshPhongMaterial( {
			...
			mesh2.scale.set( 1750, 1750, 1750 );
			mesh2.rotation.set(-125,75,-75);
			mesh2.position.set(-100,-800,0);
			scene.add( mesh2 );

			mixer = new THREE.AnimationMixer( mesh2 );

			var clip = THREE.AnimationClip.CreateFromMorphTargetSequence( 'cloth2', geometry.morphTargets, 30 );
			mixer.clipAction( clip ).setDuration( 5 ).play();

	} );

	var loader = new THREE.JSONLoader();
	loader.load( "models/animated/scene.json", function ( geometry ) {
		...
		var material = new THREE.MeshPhongMaterial( {
			...
			mesh2 = new THREE.Mesh( geometry, material );
			mesh2.scale.set( 3000, 3000, 3000 );
			mesh2.rotation.set(-125,75,-75);
